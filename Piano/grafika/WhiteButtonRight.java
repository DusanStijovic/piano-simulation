...
public class WhiteButtonRight extends PianoButton {
	private int xoffset, yoffset;
		protected WhiteButtonRight(Dirke canvas, int xoffset, int yoffset) {
			super(canvas);
		...
		public void drawButton() {
			...
			g.fillRect(xoffset + 6, yoffset,23,170);
		...
		public boolean checkIfPressed(int offsetx, int offsety) {
			if(offsety <=170 && offsetx >= xoffset + 6 && offsetx <= xoffset + 29) {
